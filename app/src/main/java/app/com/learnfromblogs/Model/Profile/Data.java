...
package app.com.learnfromblogs.Model.Profile;
...
public class Data {
    ...
    @SerializedName("is_payment_display")
    @Expose
    private String isPaymentDisplay;
    ...
    public String getIsPaymentDisplay() {
        return isPaymentDisplay;
    }

    public void setIsPaymentDisplay(String isPaymentDisplay) {
        this.isPaymentDisplay = isPaymentDisplay;
    }
